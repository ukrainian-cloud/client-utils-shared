...
type LocalDBEnum<T extends keyof typeof enums> = LocalDB['enums'][T][keyof LocalDB['enums'][T]];
...
export { ColorScheme, ComponentNamed as Component, LocalDB, LocalDBEnum, Name, createUtility, getUtility, isUtility, loadUtilities, useUtil, withName };
